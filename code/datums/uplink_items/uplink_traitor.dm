...
/datum/uplink_item/dangerous/slug
	name = "Young Headslug Flask"
	reference = "YHF"
	desc = "The latest development of Biomoon Enterprises. Such young changelings are obtained by exchanging and stealing, and then genetically modified. \
			The changeling generated by such a process is in some ways weaker than adult individuals. However, there will be a psionic connection between you."
	item = /obj/item/storage/box/syndie_kit/slug
	excludefrom = list(UPLINK_TYPE_NUCLEAR, UPLINK_TYPE_SST)
	cost = 80
	refund_path = /obj/item/slug_flask
	refundable = TRUE
	surplus = 0
	cant_discount = TRUE
